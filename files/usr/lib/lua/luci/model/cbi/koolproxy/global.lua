-- Copyright 2018 Nick Peng (ooxxbbbbb@gmail.com)
...
o = Map("koolproxy", "<font color='green'>" .. translate("广告过滤 VIP ") .."</font>",     "<font color='purple'>" .. translate( "广告过滤VIP是能识别Adblock规则的广告屏蔽软件，可以过滤网页广告、视频广告、HTTPS广告.@斌哥改版自用、禁止商业用途") .."</font>")
